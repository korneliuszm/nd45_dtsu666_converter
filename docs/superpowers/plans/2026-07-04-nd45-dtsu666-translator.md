...
```json
{
  "nd45_source": {
    ...
    "points": {
      ...
      "imp_energy_l1": {"compose": [900, 902], "factors": [1000, 1]},
      "imp_energy_l2": {"compose": [904, 906], "factors": [1000, 1]},
      "imp_energy_l3": {"compose": [908, 910], "factors": [1000, 1]},
      "exp_energy_total": {"compose": [928, 930], "factors": [1000, 1]},
      "exp_energy_l1": {"compose": [916, 918], "factors": [1000, 1]},
      "exp_energy_l2": {"compose": [920, 922], "factors": [1000, 1]},
      "exp_energy_l3": {"compose": [924, 926], "factors": [1000, 1]}
    }
  },
  "dtsu_target": {
    "word_order": "big",
    ...
    "points": {
      ...
      "imp_ep_l1":  {"addr": 4128, "from": "imp_energy_l1", "scale": 1},
      "imp_ep_l2":  {"addr": 4130, "from": "imp_energy_l2", "scale": 1},
      "imp_ep_l3":  {"addr": 4132, "from": "imp_energy_l3", "scale": 1},
      "net_imp_ep": {"addr": 4134, "from": "net_imp_energy_total", "scale": 1},
      "exp_ep":     {"addr": 4136, "from": "exp_energy_total", "scale": 1},
      "exp_ep_l1":  {"addr": 4138, "from": "exp_energy_l1", "scale": 1},
      "exp_ep_l2":  {"addr": 4140, "from": "exp_energy_l2", "scale": 1},
      "exp_ep_l3":  {"addr": 4142, "from": "exp_energy_l3", "scale": 1},
      "net_exp_ep": {"addr": 4144, "from": "net_exp_energy_total", "scale": 1}
    }
  }
}
```
