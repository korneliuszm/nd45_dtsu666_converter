...
This deployment runs **two bridges as two systemd services** (`nd45-dtsu666@nd45`, `nd45-dtsu666@smartlogger`): `nd45` (Lumel ND45 → `/dev/ttyAMA2`, grid-tie balance) and `smartlogger` (Huawei SmartLogger → `/dev/ttyAMA4`, PV farm production). See `docs/superpowers/specs/2026-07-30-huawei-smartlogger-source-design.md`.
